  ...
  return (
    <SafeAreaView style={s.root}>
      ...
      <ScrollView contentContainerStyle={s.gateScroll}>
        <Text style={[s.wordmark, MONO, { fontSize: 17, marginBottom: 18 }]}>TIL<Text style={{ color: C.accent }}>T</Text></Text>
        <Text style={[s.gateH, SERIF]}>Before you begin</Text>
        <Text style={s.gateP}>Tilt publishes geopolitical analysis and probabilistic forecasts as <Text style={{ color: C.text, fontWeight: '700' }}>opinion</Text> — not fact, and not advice.</Text>
    ...
    <SafeAreaProvider>
      <SafeAreaView style={s.root} edges={['top']}>
        ...
        <View style={s.header}>
          ...
          <Text style={[s.wordmark, MONO]}>TIL<Text style={{ color: C.accent }}>T</Text></Text>
